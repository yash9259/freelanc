    ...
    <div className="portfolio bg-gradient min-vh-100 text-black" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <section id="about" className="py-5 bg-light text-dark border-top">
        <div className="container d-md-flex align-items-center">
          <motion.img src="C:\Users\ADMIN\Desktop\freelanc\WhatsApp Image 2025-02-12 at 11.55.24_3e3aecb1.jpg" alt="Yash Thakkar" className="rounded-circle shadow-lg mb-4 mb-md-0 me-md-5" whileHover={{ scale: 1.1 }} />
          <div>
            <h2>About Me</h2>
